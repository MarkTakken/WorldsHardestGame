...
class Level4 extends Game
{
    ...
    ArrayList<Enemy> key1 = new ArrayList<Enemy>();
    ArrayList<Enemy> key2 = new ArrayList<Enemy>();
    ArrayList<Enemy> key3 = new ArrayList<Enemy>();
    ArrayList<Enemy> key4 = new ArrayList<Enemy>();
    Targeter targeter;
    Level4()
    {
        ...
        key1.add(new Enemy(360,400,1,1));
        key1.add(new Enemy(240,400,1,1,Math.PI));
        keysLeft.add(new Key(300,225));
        key2.add(new Enemy(300,165,1,1,Math.PI/2));
        key2.add(new Enemy(300,285,1,1,3*Math.PI/2));
        keysLeft.add(new Key(550,400));
        key3.add(new Enemy(550,340,1,1,Math.PI/2));
        key3.add(new Enemy(550,460,1,1,3*Math.PI/2));
        keysLeft.add(new Key(550,225));
        key4.add(new Enemy(610,225,1,1));
        key4.add(new Enemy(490,225,1,1,Math.PI));
        ...
        targeter = new Targeter(425,315,3,1);
        ...
        for (Enemy enemy : radius270)
            ignoringEnemies.add(enemy);
        for (Enemy enemy : key1)
            ignoringEnemies.add(enemy);
        for (Enemy enemy : key2)
            ignoringEnemies.add(enemy);
        for (Enemy enemy : key3)
            ignoringEnemies.add(enemy);
        for (Enemy enemy : key4)
            ignoringEnemies.add(enemy);
    }
    ...
    public void update()
    {
        ...
        for (Enemy enemy : key1)
            enemy.moveInCircle(300,400,60,"cw");
        for (Enemy enemy : key2)
            enemy.moveInCircle(300,225,60,"cw");
        for (Enemy enemy : key3)
            enemy.moveInCircle(550,400,60,"cw");
        for (Enemy enemy : key4)
            enemy.moveInCircle(550,225,60,"cw");
    }
}
